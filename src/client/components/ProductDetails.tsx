...
export const ProductDetails: React.FC<ProductDetailsProps> = ({ product }) => {
    ...
    return (
        <div data-testid="product-page" className={bem(null, ['row'])}>
            ...
            <div className="col-12 col-sm-7 col-lg-6">
                ...
                <p>
                    <button data-testid='button-add-cart' className={bem("AddToCart", ['btn', 'btn-primary', btnSizeClass])} onClick={onClick}>Add to Cart</button>
